...
function createClassificar(grupo, point){
    ...
    return `
     ...
     <blockquote cite="https://www.fifa.com/fifaplus/pt/articles/copa-do-mundo-2022-selecoes-grupos-datas-ingressos" > Apenas os dois primeiros colocados por grupo é classificado.</blockquote>
     <hr>
     </div>   `
}
